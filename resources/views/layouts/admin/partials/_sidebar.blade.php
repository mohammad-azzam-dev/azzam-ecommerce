                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                   title="{{translate('Business Section')}}">{{\App\CentralLogics\translate('business')}} {{\App\CentralLogics\translate('section')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{Request::is('admin/business-settings/ecom-setup')?'active':''}}">
                                    ...
                                    >
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span
                                            class="text-truncate">{{\App\CentralLogics\translate('ecommerce')}} {{\App\CentralLogics\translate('setup')}}</span>
                                    </a>
                                </li>
                                ...
                                <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/return-page*')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.business-settings.return_page_index')}}"
                                ...
                                <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/refund-page*')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.business-settings.refund_page_index')}}"
                                ...
                                <li class="navbar-vertical-aside-has-menu {{Request::is('admin/business-settings/cancellation-page*')?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.business-settings.cancellation_page_index')}}"
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                   title="{{translate('deliveryman section')}}">{{\App\CentralLogics\translate('deliveryman')}} {{\App\CentralLogics\translate('section')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle"
                                   title="{{translate('customer section')}}">{{\App\CentralLogics\translate('customer')}} {{\App\CentralLogics\translate('section')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
