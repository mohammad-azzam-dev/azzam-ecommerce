            ...
            <div class="navbar-nav-wrap-content-right">
                ...
                <ul class="navbar-nav align-items-center flex-row">
                    <li class="nav-item d-none d-sm-inline-block">
                        <div class="dropdown">
                            <button class="btn btn-white dropdown-toggle btn-sm" type="button" id="dropdownMenuButton"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                {{ strtoupper(app()->getLocale()) }} <i class="fa-solid fa-chevron-down"></i>
                            </button>
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item"
                                    href="{{ route('change-language') }}?language=ar">{{ translate('arabic') }}</a>
                                <a class="dropdown-item"
                                    href="{{ route('change-language') }}?language=en">{{ translate('english') }}</a>
                            </div>
                        </div>
                    </li>
