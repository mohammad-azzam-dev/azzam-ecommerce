    ...
    <div class="container py-5 py-sm-7">
        <a class="d-flex justify-content-center mb-5" href="javascript:">
            <img class="z-index-2"
                 ...
                 src="{{asset('storage/app/public/ecommerce')}}/{{\App\Model\BusinessSetting::where(['key'=>'logo'])->first()->value}}" alt="Image Description" style="width: 300px;">
        </a>
                    ...
                    <div class="card-body">
                        ...
                        <form id="form-id" action="{{route('branch.auth.login')}}" method="post">
                            ...
                            <div class="text-center">
                                <div class="mb-5">
                                    <h1 class="display-4">{{ translate('Branch Sign in') }}</h1>
                                    <p>{{ translate('Want to login your admin account?') }}
