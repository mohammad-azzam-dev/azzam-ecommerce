                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form Group -->
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="button" onclick="{{env('APP_MODE')!='demo'?"form_alert('changePasswordForm',
                                  '".translate("Want to update admin info ?")."')":"call_demo()"}}" class="btn btn-primary">{{translate('Save Changes')}}</button>
                            </div>
                        </form>
                        <!-- End Form -->
                    </div>
