        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title"><i class="tio-filter-list"></i> {{\App\CentralLogics\translate('deliveryman')}} {{\App\CentralLogics\translate('list')}} <span class="text-primary">{{ $delivery_men->total() }}</span></h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
