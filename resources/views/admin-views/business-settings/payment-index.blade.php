    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{ \App\CentralLogics\translate('payment') }}
                        {{ \App\CentralLogics\translate('gateway') }} {{ \App\CentralLogics\translate('setup') }}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        <h5 class="text-center">{{ \App\CentralLogics\translate('payment') }}
        ...
        <div class="row" style="padding-bottom: 20px">
                ...
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                <div class="form-group mb-2">
                                    <label class="control-label">{{ \App\CentralLogics\translate('sslcommerz') }}
                                        {{ \App\CentralLogics\translate('payment') }}</label>
                                </div>
                                <div class="form-group mb-2 mt-2">
                                    <input type="radio" name="status" value="1"
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('store') }}
                                        {{ \App\CentralLogics\translate('id') }} </label><br>
                                    <input type="text" class="form-control" name="store_id"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['store_id'] : '' }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('store') }}
                                        {{ \App\CentralLogics\translate('password') }}</label><br>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label
                                        style="padding-left: 10px">{{ \App\CentralLogics\translate('razorkey') }}</label><br>
                                    <input type="text" class="form-control" name="razor_key"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['razor_key'] : '' }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label
                                        style="padding-left: 10px">{{ \App\CentralLogics\translate('razorsecret') }}</label><br>
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-2 mt-2">
                                    <input type="radio" name="status" value="1"
                                        {{ $config['status'] == 1 ? 'checked' : '' }}>
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('active') }}
                                    </label>
                                    <br>
                                </div>
                                <div class="form-group mb-2">
                                    <input type="radio" name="status" value="0"
                                        {{ $config['status'] == 0 ? 'checked' : '' }}>
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('inactive') }}
                                    </label>
                                    <br>
                                </div>
            ...
            <div class="col-md-6" style="margin-top: 26px!important;">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        <h5 class="text-center">{{ \App\CentralLogics\translate('myFatoorah') }}</h5>
                        @php($config = \App\CentralLogics\Helpers::get_business_settings('myFatoorah'))
                        <form
                            ...
                            @if (isset($config))
                                {{-- Is active? --}}
                                <div class="form-group mb-2">
                                    <label class="control-label">{{ \App\CentralLogics\translate('myFatoorah') }}</label>
                                </div>
                                <div class="form-group mb-2 mt-2">
                                    <input type="radio" name="status" value="1"
                                        {{ $config['status'] == 1 ? 'checked' : '' }}>
                                ...
                                {{-- API key --}}
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('myFatoorah') }}
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('myFatoorah') }}
                                        {{ \App\CentralLogics\translate('country_code') }}
                                    </label>
                                    <br>
                                    <select class="form-control" name="country_code" required>
                                        <option value="KWT" {{ (env('APP_MODE') != 'demo' ? $config['country_code'] : '') == 'KWT' ? 'selected' : '' }}>KWT</option>
                                    </select>
                                </div>

                                {{-- Is test? --}}
                                <div class="form-group mb-2">
                                    <label class="control-label">{{ \App\CentralLogics\translate('is_test') }}?</label>
                                </div>
                                <div class="form-group mb-2 mt-2">
                                    <input type="radio" name="is_test" value="1"
                                        {{ $config['is_test'] == 1 ? 'checked' : '' }}>
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('test') }}
                                    </label>
                                    <br>
                                </div>
                                <div class="form-group mb-2">
                                    <input type="radio" name="is_test" value="0"
                                        {{ $config['is_test'] == 0 ? 'checked' : '' }}>
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('production') }}
                                    </label>
                                    <br>
                                </div>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('paypal') }}
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('paypalsecret') }}
                                    </label><br>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('published') }}
                                        {{ \App\CentralLogics\translate('key') }}</label><br>
                                    <input type="text" class="form-control" name="published_key"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['published_key'] : '' }}">
                                </div>

                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('api') }}
                                        {{ \App\CentralLogics\translate('key') }}</label><br>
                                    <input type="text" class="form-control" name="api_key"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['api_key'] : '' }}">
                                </div>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('secretKey') }}
                                    </label><br>
                                    <input type="text" class="form-control" name="secretKey"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['secretKey'] : '' }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('paymentUrl') }}
                                    </label><br>
                                    <input type="text" class="form-control" name="paymentUrl"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['paymentUrl'] : '' }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('merchantEmail') }}
                                    </label><br>
            ...
            <div class="col-md-6 pt-4">
                <div class="card">
                    <div class="card-body" style="padding: 20px">
                        <h5 class="text-center">{{ \App\CentralLogics\translate('senang') }}
                            {{ \App\CentralLogics\translate('pay') }}</h5>
                        ...
                        <form
                            ...
                            @if (isset($config))
                                <div class="form-group mb-2">
                                    <label class="control-label">{{ \App\CentralLogics\translate('senang') }}
                                        {{ \App\CentralLogics\translate('pay') }}</label>
                                </div>
                                <div class="form-group mb-2 mt-2">
                                    <input type="radio" name="status" value="1"
                                        {{ $config['status'] == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('secret') }}
                                        {{ \App\CentralLogics\translate('key') }}</label><br>
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('merchant') }}
                                        {{ \App\CentralLogics\translate('id') }}</label><br>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                ...
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('bkash') }}
                                        {{ \App\CentralLogics\translate('api') }}
                                        {{ \App\CentralLogics\translate('key') }}</label><br>
                                    <input type="text" class="form-control" name="api_key"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['api_key'] ?? '' : '' }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('bkash') }}
                                        {{ \App\CentralLogics\translate('api') }}
                                        {{ \App\CentralLogics\translate('secret') }}</label><br>
                                    <input type="text" class="form-control" name="api_secret"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['api_secret'] ?? '' : '' }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('username') }}
                                    </label><br>
                                    <input type="text" class="form-control" name="username"
                                        value="{{ env('APP_MODE') != 'demo' ? $config['username'] ?? '' : '' }}">
                                </div>
                                <div class="form-group mb-2">
                                    <label style="padding-left: 10px">{{ \App\CentralLogics\translate('password') }}
                                    </label><br>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                <div class="form-group mb-2">
                                    <label
                                        class="control-label">{{ \App\CentralLogics\translate('flutterwave') }}</label>
                                </div>
                                <div class="form-group mb-2 mt-2">
                                    <input type="radio" name="status" value="1"
                                        {{ $config['status'] == 1 ? 'checked' : '' }}>
                    ...
                    <div class="card-body" style="padding: 20px">
                        ...
                        <form
                            ...
                            @if (isset($config))
                                <div class="form-group mb-2">
                                    <label
                                        class="control-label">{{ \App\CentralLogics\translate('mercadopago') }}</label>
                                </div>
                                <div class="form-group mb-2 mt-2">
                                    <input type="radio" name="status" value="1"
                                        {{ $config['status'] == 1 ? 'checked' : '' }}>
