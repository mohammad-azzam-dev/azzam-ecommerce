        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">{{\App\CentralLogics\translate('ecommerce setup')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <h5>
                                    ...
                                    {{\App\CentralLogics\translate('maintenance')}} {{\App\CentralLogics\translate('mode')}}
                                </h5>
                            </div>
                            <div class="col-6">
                        ...
                        <div class="col-md-8 col-12">
                            <div class="form-group">
                                <label class="input-label"
                                       for="exampleFormControlInput1">{{\App\CentralLogics\translate('Shop Name')}}</label>
                                <input type="text" name="restaurant_name" value="{{$name}}" class="form-control"
                                       placeholder="{{ translate('New market') }}" required>
                            </div>
                        </div>
...
{{--                        </div>--}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label>{{\App\CentralLogics\translate('email')}} {{\App\CentralLogics\translate('verification')}} ( Token
                    ...
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="text-center">{{\App\CentralLogics\translate('delivery_management')}}</h4>
                                    ...
                                    <div class="form-group pl-3">
                                        <div class="form-group pl-3">
                                            <label>{{\App\CentralLogics\translate('Minimum delivery Charge')}} </label><br>
                                        ...
                                        <div class="form-group pl-3">
                                            <label>{{\App\CentralLogics\translate('delivery Charge / Kilometer')}}</label><br>
                                    ...
                                    <div class="form-group pt-3">
                                        ...
                                        <div class="form-group pl-3" style="padding-left: 10px">
                                            @php($delivery=\App\Model\BusinessSetting::where('key','delivery_charge')->first()->value)
                                            <div class="form-group pl-3">
                                                <label for="exampleFormControlInput1">{{\App\CentralLogics\translate('Delivery Charge')}} </label>
