                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                @else
                                    <button type="button"
                                            onclick="form_alert('admin-settings-form','{{translate("Want to update admin info")}}')"
                                            class="btn btn-primary">{{ translate('Save changes') }}
                                    </button>
                                @endif
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form Group -->
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                @else
                                    <button type="button"
                                            onclick="form_alert('changePasswordForm','{{translate("Want to update admin password ?")}}')"
                                            class="btn btn-primary">{{ translate('Save Changes') }}
                                    </button>
                                @endif
                            </div>
