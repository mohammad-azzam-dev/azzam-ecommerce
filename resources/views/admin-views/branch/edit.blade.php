        ...
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title text-capitalize"><i class="tio-edit"></i> {{translate('branch')}} {{translate('update')}}</h1>
                </div>
            </div>
        </div>
        <!-- End Page Header -->
                    ...
                    <div class="row">
                        <div class="col-5">
                            <div class="form-group">
                                ...
                                <input type="number" name="latitude" value="{{$branch['latitude']}}" class="form-control" placeholder="{{ translate('Ex : -132.44442') }}"
                        ...
                        <div class="col-5">
                            <div class="form-group">
                                ...
                                <input type="number" name="longitude" value="{{$branch['longitude']}}" class="form-control" placeholder="{{ translate('Ex : 94.233') }}"
                                    {{$branch_count>1?'required':''}} step="any">
                            </div>
                        </div>
                        <div class="col-2">
