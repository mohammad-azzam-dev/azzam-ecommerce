<div style="width:410px;">
    <div class="text-center pt-4 mb-3">
        ...
        <h5 style="font-size: 20px;font-weight: lighter;line-height: 1">
            {{ \App\Model\Branch::find($order['branch_id'])->address }}
        </h5>
            ...
            @if($detail->product)
                <tr>
                    ...
                    <td class="">
                        ...
                        <span style="display: block">{{\App\CentralLogics\translate('Discount')}} : {{ Helpers::set_symbol($detail['discount_on_product']*$detail['quantity']) }}</span>
                    </td>
                    <td style="width: 28%">
    ...
    <div class="row justify-content-md-end">
        <div class="col-md-7 col-lg-7">
            <dl class="row text-right" style="color: black!important;">
                ...
                <dd class="col-6">{{ Helpers::set_symbol($order->order_amount + $order['extra_discount']) }}</dd>
                ...
                <dt class="col-6" style="font-size: 16px">{{\App\CentralLogics\translate('Total')}}:</dt>
                {{--                <dd class="col-6" style="font-size: 16px">{{$sub_total+$del_c+$total_tax-$order['coupon_discount_amount']." ".\App\CentralLogics\Helpers::currency_symbol()}}</dd>--}}
                <dd class="col-6" style="font-size: 16px">{{ Helpers::set_symbol($order->order_amount) }}</dd>
            </dl>
        </div>
    </div>
    <span>-------------------------------------------------------------------------------------</span>
