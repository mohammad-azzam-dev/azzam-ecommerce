                ...
                <div class="card">
                    ...
                    <div class="card-header flex-between">
                        <div class="flex-start">
                            <h5 class="card-header-title">{{\App\CentralLogics\translate('Banner Table')}} <span class="card-header-title text-primary mx-1">({{ $banners->total() }})</span></h5>
                        </div>
                        <div>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a class="dropdown-item" href="javascript:"
                                                   onclick="form_alert('banner-{{$banner['id']}}','{{\App\CentralLogics\translate('Want to delete this banner ?')}}')">{{\App\CentralLogics\translate('delete')}}</a>
